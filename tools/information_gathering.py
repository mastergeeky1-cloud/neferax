...
class SecretFinder(NeferaxTool):
...
class PortScannerRanger(NeferaxTool):
...
class TheHarvester(NeferaxTool):
...
class InformationGatheringTools(NeferaxToolsCollection):
